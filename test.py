...
# /home/x/tensor-flow-lite/obj-rec 
# tflite model: /home/x/tensor-flow-lite/obj-rec/TFLite_model/detect.tflite
# labels file: /home/x/tensor-flow-lite/obj-rec/TFLite_model/labelmap.txt
# image file: /home/x/tensor-flow-lite/obj-rec/gh.bmp
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '-i',
      '--image',
      default='/home/x/tensor-flow-lite/obj-rec/gh.bmp',
  ...
  if args.ext_delegate is not None:
    ...
    ext_delegate = [
        load_delegate(args.ext_delegate, ext_delegate_options)
    ]
